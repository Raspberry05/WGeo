...
/** Slightly shrink distant dots for clarity at globe scale. */
export const AIRPORT_POINT_SCALE = new NearFarScalar(8.0e5, 1.0, 1.2e7, 0.35);

/** Meters above terrain for inactive airport dots. */
export const AIRPORT_POINT_HEIGHT_M = 12;

/** Meters above terrain for the active airport dot. */
